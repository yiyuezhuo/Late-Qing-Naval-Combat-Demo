...
public class TopTabs : SingletonDocument<TopTabs>
{
    ...
    protected override void Awake()
    {
        ...
        root.Q<Button>("ExactPathfindingButton").clicked += () =>
        {
            ExactPathfindingLine.Instance?.BeginChooseStart();
        };
        ...
        root.Q<Button>("McCoyOkunCalculatorButton").clicked += () => DialogRoot.Instance.PopupMcCoyOkunCalculatorDialog();
