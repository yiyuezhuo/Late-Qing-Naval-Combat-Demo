...
namespace StrategicCombatCore
{
    ...
    public class StrategicGameState : AbstractGameState
    {
        ...
        {
            new StrategicTacticalResultApplier(this).UpdatePartialShipLogs(otherShipLogs, launchedTorpedos);
        }

        public void CleanupIndependentStrategicGroups()
        {
            new StrategicTacticalResultApplier(this).CleanupIndependentStrategicGroups();
        }
        ...
        {
            new StrategicTacticalResultApplier(this).UpdateFromTacticalResult(syncShipLogs, victoryStatus, launchedTorpedos);
        }
        ...
        {
            new StrategicNavalIntelligenceResolver(this).Advance1HourForContactReport();
        }
        ...
        {
            new StrategicNavalIntelligenceResolver(this).UpdateContactReport(observerSide, observedSide, cell, observedSideDeployedShipLogs, matchedContactReport);
        }

        public void Advance1HourForRaiding()
        {
            new StrategicNavalIntelligenceResolver(this).Advance1HourForRaiding();
        }
        ...
        internal bool TryAutoDetachDamagedShips(StrategicGroup group)
        {
            if (group == null ||
        ...
        {
            new StrategicLandBattleLifecycleResolver(this).Advance1Hour();
        }
        ...
        {
            return new StrategicNavalIntelligenceResolver(this).GetSearchValueDayNightCoef(cell);
        }
