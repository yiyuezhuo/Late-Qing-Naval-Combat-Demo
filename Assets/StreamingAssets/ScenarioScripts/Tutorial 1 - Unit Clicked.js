...
You can also use the "Advance 1 Min" button in the Command tab of the top bar to advance time.
`,
`
...
上部バーの「コマンド」タブにある「1分進める」ボタンでも時間を進められます。
`,
`
单位已选中。右侧显示了对应的信息面板。
...
也可以使用顶部栏“命令”标签页中的“推进1分钟”按钮推进时间。
`,
`
單位已選中。右側顯示了對應的信息面板。
...
也可以使用頂部欄「命令」標籤頁中的「推進1分鐘」按鈕推進時間。
`);
