...
- 到达期望位置后，使用“反转控制链”按钮，将所有控制关系反转（例如，它把“A 跟随 B”变成“B 跟随 A”）。然后在“按跟随链排列队形”按钮的对话框中，将编队从绝对定位切换为跟随队形。再继续航行 5 分钟。
...
- 到達期望位置後，使用「反轉控制鏈」按鈕，將所有控制關係反轉（例如，它把「A 跟隨 B」變成「B 跟隨 A」）。然後在「按跟隨鏈排列隊形」按鈕的對話框中，將編隊從絕對定位切換為跟隨隊形。再繼續航行 5 分鐘。
...
これらの確認が終わったら、このチュートリアルを終了して次のシナリオに進んで構いません。
`,
`
