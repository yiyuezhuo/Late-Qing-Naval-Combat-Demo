...
`,
`
欢迎来到教程 4：编队控制。你已经在教程 2 中学习过“低层”的舰队编组控制；在这里，你将学习如何更高效地完成这些操作。

首先，请观察第 1 战队的机动，直到新的消息对话框弹出为止（大约会持续 20 分钟游戏时间）。这同时也是黄海海战前期历史机动的一个示意。
`,
`
歡迎來到教學 4：編隊控制。你已經在教學 2 中學過「低層」的艦隊編組控制；在這裡，你將學習如何更有效率地完成這些操作。

首先，請觀察第 1 戰隊的機動，直到新的訊息對話框彈出為止（大約會持續 20 分鐘遊戲時間）。這同時也是黃海海戰前期歷史機動的一個示意。
`);
