...
`,
`
可以看到所有北洋水师的单位开始自动开火了。现在在鱼雷艇队级别把自动机动的继承关闭并切为自动。推进到新提示弹出。
`,
`
...
その後 OOB エディターで北洋艦隊の項目を開くと、自動機動ドクトリンが自動に変わっているはずです。これは、この A/I ダイアログは、戦闘序列の最上位層における自動機動ドクトリンを設定するためのショートカットに過ぎません
