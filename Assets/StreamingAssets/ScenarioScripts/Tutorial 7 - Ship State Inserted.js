...
「吉野1」を選択し、Fキーまたはトップタブの「追従(F)」ボタンを押してから「吉野」をクリックし、「吉野1」が「吉野」に追従するよう設定してください。次に、「吉野2」が「吉野1」に追従するよう設定します。「吉野」（グループリーダー）の目標速力を10ノット、針路を90度（東）に設定してください。その後、エディタタブの「陣形位置に設定」ボタンをクリックします（ボタンが有効でない場合は、コマンドタブで「エディターモード」を有効にしてください）。艦艇の位置、速力、針路が編隊関係に従って更新されます。
`,
`
