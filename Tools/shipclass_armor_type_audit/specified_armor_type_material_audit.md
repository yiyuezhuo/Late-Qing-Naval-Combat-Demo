...
| Variag | `HighTensileSteel` | 0.82 | Extra-soft nickel steel deck armor | Likely inconsistent | `NickelSteel` | [TopWar: Retvisan vs Tsesarevich / Cramp contracts](https://en.topwar.ru/166338-retvizan-vs-cesarevich-ili-a-pochemu-ne-kramp.html) | Source discusses the surcharge for Varyag's cruiser deck armor being supplied as extra-soft nickel steel. |
